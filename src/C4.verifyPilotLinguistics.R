...
#' @author John James
#' @export
verifyPilotLinguistics <- function(hcCorpus, pilot, registers, posTags, directories) {
...
## ---- end
#features <- verifyPilotLinguistics(corpora$clean, corpora$training, posTags, directories)