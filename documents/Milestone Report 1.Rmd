---
title: "PredictifyR | Integrated Word Prediction Model - Milestone Report 1"
author: "John James"
...
```{r cacheSetup, echo=F, eval=T, message=F, warning=F, cache=F, results='hide'}
opts_chunk$set(cache.extra = docSource)
